        ...
        <div class="container">
            <div class="row gx-0">
                <div class="rule">
                    ...
                    <h5> TIME ALLOWED: <?php echo ($exam['Time'])/60;?> HOURS</h5>
                    <h6> GENERAL DIRECTIONS </h6>
                    <p> THIS IS  <span> <?php echo strtoupper($exam['Exam_name']);?></span> THE  EXAMINATION  CONTAINS <span> <?php echo $exam['No_of_ques'];?> </span> QUESTIONS.  
                    ...
                    <p> YOU  WILL  BE  ALLOWED  TO  WORK  FOR <span> <?php echo ($exam['Time'])/60;?> </span> HOURS.  
