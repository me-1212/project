...
if (isset($_POST['submit'])) {
    ...
    $_SESSION['questions'][$current_question]['selected_answer'] = $selected_answer;

    // Check if the selected answer is correct
    if ($selected_answer == $_SESSION['questions'][$current_question]['Answer']) {
        // Increment the score
        $_SESSION['score']++;
    }
    ...
    if ($_SESSION['current_question'] == count($_SESSION['questions'])) {
        ...
        header("Location: review_exam.php?id=$exam_id");
        exit;
    }
}
}
