    ...
    <header id="header">
      <div class="row">
            <i class="bi bi-newspaper">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="white" class="bi bi-newspaper" viewBox="0 0 16 16">
      ...
      <form action="post_news.php" method="post" enctype="multipart/form-data">
        ...
        <div class="form-row col-lg-3">
          <div class="mb-3">
            ...
            <input class="form-control" type="textarea" name = "title" placeholder="Enter news title">
          </div>
        </div>
        <div class="form-row col-lg-3">
          <label for="textarea" class="form-label" style="font-weight:bold;">News description</label>
          <input class="form-control" type="textarea" name = "description" placeholder="Enter the full description">
        </div>
        <!-- <div class="form-row col-lg-3">
