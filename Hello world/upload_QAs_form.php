...
<html>
    ...
    <body>
        ...
        <i class="bi bi-question-octagon">
            <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="white" class="bi bi-question-octagon" viewBox="0 0 16 16">
                ...
                <form action="upload_QAs.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-row mb-3">
                            ...
                            <?php
                                if(isset($_GET['id'])){ ?>
                                <input class="form-control" type="text" name = "exam_id" value ="<?php echo $_GET['id']; ?>" readonly>
                            <?php }?>
                        </div>
                        <div class="form-row mb-3">
                            <label for="input" class="form-label" style="font-weight:bold;">Question Number</label>
                            <input class="form-control" type="number" name = "question_id" placeholder="Enter question number">
                        </div>
                        <div class="form-row mb-3">
                            <label for="textarea" class="form-label" style="font-weight:bold;">Question</label>
                            <textarea class="form-control" name = "question" placeholder="Enter the question" rows="4" cols="50"></textarea>
                        </div>
                        <div class="form-row mb-3">
                            <label for="textarea" class="form-label" style="font-weight:bold;">Choice A</label>
                            <textarea class="form-control" name = "ch_a" placeholder="Enter choice A" rows="4" cols="50"></textarea>
                        </div>
                        <div class="form-row mb-3">
                            <label for="formFile" class="form-label" style="font-weight:bold;">Choice B</label>
                            <textarea class="form-control" type="textarea" name = "ch_b" placeholder="Enter choice B" rows="4" cols="50"></textarea>
                        </div></div>
                        <div class="col-lg-1"></div>
                        <div class="col-lg-5">
                        <div class="form-row mb-3">
                            <label for="formFile" class="form-label" style="font-weight:bold;">Choice C</label>
                            <textarea class="form-control" type="textarea" name = "ch_c" placeholder="Enter choice C" rows="4" cols="50"></textarea>
                        </div>
                        <div class="form-row mb-3">
                            <label for="formFile" class="form-label" style="font-weight:bold;">Choice D</label>
                            <textarea class="form-control" type="textarea" name = "ch_d" placeholder="Enter choice D" rows="4" cols="50"></textarea>
                        </div>
                        <div class="form-row mb-3">
                            <label for="formFile" class="form-label" style="font-weight:bold;">Answer</label>
                            <input class="form-control" type="text" name = "answer" placeholder="Enter the answer">
                        </div>
                        <div class="form-row mb-3">
        ...
        ?>
            <section id="view">
                <div class="row">
                    <h3>You can't add questions since the maximum limit is reached. <br> Click the link below to view questions.</h3>
                </div>
